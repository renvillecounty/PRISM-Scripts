...
FUNCTION create_pay_or_report_dlg(num_of_months, pay_or_report_dates_array)
	...
	ComboBox 175, 11, 110, 15, ""+chr(9)+"Tonya D.F. Berzat"+chr(9)+"Paul C. Clabo"+chr(9)+"Dorrie B. Estebo"+chr(9)+chr(9)+"Francine Mocchi"+chr(9)+"Brett Schading"+chr(9)+"D. Marie Sieber", CAO_list
