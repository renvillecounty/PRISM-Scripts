...
Dialog Dialog1  'This is what i needed to make the dialog run
...
EMWriteScreen (CSO_Name_Dialog), 16,15  'CSO Name typed into dialog box
...
EMWriteScreen (CSO_Title_Dialog), 16,15  'CSO title typed into dialog box
...
EMWriteScreen (CSO_Phone_Dialog), 16,15  'CSO phone typed into dialog box
...
EMWriteScreen "A", 3, 29    'Writing the CAAD note
...
EMWriteScreen "Notice of Parental Liability sent to NCP", 17,4

Transmit

pf3

Call navigate_to_Prism_Screen ("CAWT") 'telling Prism to go to the CAWT screen

pf5

EMSetCursor 4,37   'Adding the CAWT note with due date out 14 days
